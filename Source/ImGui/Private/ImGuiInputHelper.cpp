...
//--------------------------------------------------------------------------------------------------------------------------
APlayerController* FImGuiInputHelper::GetFirstLocalPlayerController(const UWorld& World)
{
...
//--------------------------------------------------------------------------------------------------------------------------
UPlayerInput* FImGuiInputHelper::GetPlayerInput(const UWorld& World)
{
...
//--------------------------------------------------------------------------------------------------------------------------
bool FImGuiInputHelper::IsKeyEventHandled(UWorld* World, const FKeyEvent& KeyEvent)
{
    //------------------------------------------------------------------------------------------------
    ...
    // We update ImGui modifier keys in SImGuiWidget::TickKeyModifiers().
    //------------------------------------------------------------------------------------------------
...
//--------------------------------------------------------------------------------------------------------------------------
bool FImGuiInputHelper::IsCheckBoxStateMatchingValue(ECheckBoxState CheckBoxState, bool bValue)
{
...
//--------------------------------------------------------------------------------------------------------------------------
bool FImGuiInputHelper::IsKeyEventMatchingKeyInfo(const FKeyEvent& KeyEvent, const FImGuiKeyInfo& KeyInfo)
{
...
//--------------------------------------------------------------------------------------------------------------------------
ECheckBoxState FImGuiInputHelper::MakeCheckBoxState(uint8 RequireValue, uint8 IgnoreValue)
{
    if (RequireValue)
    {
...
//--------------------------------------------------------------------------------------------------------------------------
void FImGuiInputHelper::KeyBindToKeyInfo(const FKeyBind& KeyBind, FImGuiKeyInfo& KeyInfo)
{
...
//--------------------------------------------------------------------------------------------------------------------------
void FImGuiInputHelper::KeyInfoToKeyBind(const FImGuiKeyInfo& KeyInfo, FKeyBind& KeyBind)
{
...
//--------------------------------------------------------------------------------------------------------------------------
bool FImGuiInputHelper::WasKeyInfoJustPressed(APlayerController& PlayerController, const FImGuiKeyInfo& KeyInfo)
{
...
//--------------------------------------------------------------------------------------------------------------------------
bool FImGuiInputHelper::IsKeyBoundToCommand(UWorld* World, const FKeyEvent& KeyEvent)
{
    if (World == nullptr)
    {
        return false;
...
//--------------------------------------------------------------------------------------------------------------------------
bool FImGuiInputHelper::IsConsoleEvent(const FKeyEvent& KeyEvent)
{
...
//--------------------------------------------------------------------------------------------------------------------------
bool FImGuiInputHelper::IsStopPlaySessionEvent(const FKeyEvent& KeyEvent)
{
#if WITH_EDITOR
...
//--------------------------------------------------------------------------------------------------------------------------
uint32 FImGuiInputHelper::ToImGuiMouseButton(const FKey& MouseButton)
{
...
//--------------------------------------------------------------------------------------------------------------------------
EMouseCursor::Type FImGuiInputHelper::ToSlateMouseCursor(ImGuiMouseCursor MouseCursor)
{
    switch (MouseCursor)
    {
...
//--------------------------------------------------------------------------------------------------------------------------
FString FImGuiInputHelper::CommandToString(const UWorld& World, const FString& Command)
{
    const UPlayerInput* PlayerInput = GetPlayerInput(World);
    if (PlayerInput == nullptr)
    {
...
//--------------------------------------------------------------------------------------------------------------------------
FString FImGuiInputHelper::CommandToString(const UPlayerInput* PlayerInput, const FString& Command)
{
    if (PlayerInput == nullptr)
    {
        return FString();
...
//--------------------------------------------------------------------------------------------------------------------------
FString FImGuiInputHelper::KeyBindToString(const FKeyBind& KeyBind)
{
    FString Result;
    if (KeyBind.Alt)
    {
...
//--------------------------------------------------------------------------------------------------------------------------
bool FImGuiInputHelper::IsKeyEventMatchingKeyBind(const FKeyEvent& KeyEvent, const FKeyBind& KeyBind)
{
...
//--------------------------------------------------------------------------------------------------------------------------
bool FImGuiInputHelper::IsKeyBoundToCommand(const UPlayerInput* InPlayerInput, const FKeyEvent& KeyEvent)
{
...
//--------------------------------------------------------------------------------------------------------------------------
bool FImGuiInputHelper::IsMouseInsideMainViewport()
{
...
//--------------------------------------------------------------------------------------------------------------------------
ImGuiKey FImGuiInputHelper::ToImKey(const FKey& Key)
{
