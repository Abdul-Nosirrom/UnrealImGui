...
#include "ImGuiDebug.generated.h"

class AActor;
class UObject;
class UWorld;
struct FImGuiDebugDrawLineTraceParams;
struct FImGuiDebugDrawOverlapParams;
struct FImGuiDebugDrawSweepParams;

UENUM()
enum EImGuiDebugRecolorMode : uint8
{
    None,
    Color,
	HueOverTime,
...
struct FImGuiDebugSettings
{
    ...
    UPROPERTY(Config)
    TEnumAsByte<EImGuiDebugRecolorMode> RecolorMode = None;
...
class IMGUIDEBUG_API FImGuiDebugHelper
{
public:
...
struct IMGUIDEBUG_API FImGuiDebug
{
public:
    ...
    static void SetIsFilteringBySelection(bool Value);
    ...
    static void GetDebugDrawOverlapSettings(FImGuiDebugDrawOverlapParams& Params);

    static void GetDebugDrawLineTraceSettings(FImGuiDebugDrawLineTraceParams& Params);

    static void GetDebugDrawSweepSettings(FImGuiDebugDrawSweepParams& Params);

    static FImGuiDebugSettings Settings;
